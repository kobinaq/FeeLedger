  ...
  return (
    <>
      ...
      <section className="grid gap-6 xl:grid-cols-2">
        ...
        <Card><CardTitle>Staff Users</CardTitle><div className="mt-4 space-y-2"><div className="flex justify-between rounded-md bg-slate-50 p-3"><span>{profile.full_name}</span><strong>{profile.role.replaceAll("_", " ")}</strong></div></div><Button className="mt-4" variant="secondary">Invite Staff User</Button></Card>
      </section>
    </>
  );
}
